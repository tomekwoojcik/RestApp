...
import RequireAuth, { EmployeeRole } from "../../components/molecules/requireAuth/RequireAuth";
    ...
    <ThemeProvider theme={theme}>
      <Routes>
        <Route path="/" element={<Layout />}>
          ...
          <Route element={<RequireAuth allowedRole={[EmployeeRole.Employee]} />}>
          ...
          <Route element={<RequireAuth allowedRole={[EmployeeRole.Director, EmployeeRole.Supervisor]} />}>
