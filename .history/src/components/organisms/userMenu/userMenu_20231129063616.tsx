...
const Main = styled('main', { shouldForwardProp: (prop) => prop !== 'open' })<StyledAppBarProps>(
  ({ theme, open }) => ({
    flexGrow: 1,
...
function useContext(UserContext: any): { data: any; userButtons: any; supervisorButtons: any; userRoleArr: any; } {
