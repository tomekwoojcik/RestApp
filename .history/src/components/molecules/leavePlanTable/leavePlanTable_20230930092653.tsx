...
const LeavePlanTable: FC<propsModel> = ({ tableHeaders, arr, rowsPerPage, page, handleChangePage, handleChangeRowsPerPage, rowComponent }) => {
  return (
      ...
      <TableBody>
          {(rowsPerPage > 0
            ...
            .map((obj: any) => (
             ...
             rowComponent ? <UserLeaveRequestRow key={obj.leaveId} props={undefined} /> : <LeavePlanDetailsRow customKey={obj.leaveId} obj={obj} />
          )))}
        </TableBody>
         <FooterTable
