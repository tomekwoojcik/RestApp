...
function LoginInput() {
  ...
  return (
    <Input onChange={e => { handleValue(e, setLoginValue); }} id={LoginInputModule[""]} className={LoginInputModule.loginInput} type="text" name="id" placeholder="Enter your email or work id." />
  );
}
