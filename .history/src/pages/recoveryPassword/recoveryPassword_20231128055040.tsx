    ...
    <RecoveryProvider>
      <div className={RecoveryPasswordModule.masterBackground}>
        ...
        <div className={RecoveryPasswordModule.formRecovery}>
          <h2 className={RecoveryPasswordModule.headParagraph}>Forgot Password</h2>
          <p className={RecoveryPasswordModule.otherParagraph}>Contact your supervisor or accounting for a temporary password.</p>
          <p className={RecoveryPasswordModule.orParagraph}>or</p>
          <p className={RecoveryPasswordModule.otherParagraph}>Enter your ID into the form and wait for an answer.</p>
          <RecoveryForm />
          <Button variant="outlined"><Link to="/">Go back to the login page.</Link></Button>
