...
const EmployeeTable: FC<TableProps> = () => {
  const { tableHeaders, state, handleChangePage,  handleChangeRowsPerPage} = useContext(
    SupervisorContext,
  );
  return (
    <ThemeProvider theme  ={theme}>
      <Table>
        ...
        <FooterTable arrLength={state.subordinatesArr.length} rowsPerPage={state.rowsPerPage} page={state.rowsPerPage} onPageChange={handleChangePage} />
      </Table>
    </ThemeProvider>
  );
};
