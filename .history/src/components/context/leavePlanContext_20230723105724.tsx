...
// interface LeavePlanContextType {
//   dayFun: (personId: string, leaveId: string) => LeavePlanItem[];
//   // Add other properties and functions related to the context if needed.
// }
interface LeavePlanContextType {
  setFirstDate: React.Dispatch<any>;
  setLastDate: React.Dispatch<any>;
  leaveArr: string[];
  setLeave: React.Dispatch<React.SetStateAction<string>>;
  setPersonReplace: React.Dispatch<any>;
  dataRender: object[]; // Add this property
  leave: string; // Add this property
  personReplace: string; // Add this property
  dayFun: (personId: string, leaveId: string) => LeavePlanItem[]; // Add this property
  menuListArr: string[]; // Add this property
  handleActionLeave: (e: any) => void; // Add this property
  dataRenderConfirm: object[]; // Add this property
  warnMess: object[];
}

const LeavePlanContext = createContext({} as LeavePlanContextType);
