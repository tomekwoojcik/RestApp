...
const LeavePlanDetailsRow: FC<DestructDetailsModel> = ({ customKey, obj, supervisorMenu }) => {
  ...
  return (
    <TableRow key={customKey}>
      ...
      <TableCell>
        {supervisorMenu.text == "supervisorMenu" ? <SupervisorMenuForRowDetails/> : <MenuListLeavePlan leaveId={obj.leaveId} />}
