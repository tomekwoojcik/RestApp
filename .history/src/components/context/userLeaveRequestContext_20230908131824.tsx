...
export interface leaveObjModel {
  dateOfApplication: "2023-08-22T03:58:45.056Z";
  endDateOfLeave: "2023-08-26T03:58:31.000Z";
  holidayWorkerApprovalStatus: "planned";
  kindLeave: "Unpaid Leave";
  leaveId: "kAIE-xvCri";
  personId: 1;
  replacementPerson: "John Brzezinski";
  startDateOfLeave: "2023-09-12T03:58:31.000Z";
