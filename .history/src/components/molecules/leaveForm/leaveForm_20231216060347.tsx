  ...
  return (
    <FormControl className={LeaveFormModule.formDiv}>
      <LocalizationProvider dateAdapter={AdapterDayjs}>
        <label className={LeaveFormModule.label}>Plan your rest.</label>

        <DatePicker
          className={LeaveFormModule.datePicker}
          defaultValue={dayjs(new Date())}
          onChange={(e: Dayjs | null) =>
            handleDay(REDUCER_ACTION_TYPE.FIRST_DAY, e)
          }
        ...
        <DatePicker
          ...
          defaultValue={dayjs(new Date())}
          onChange={(e: Dayjs | null) =>
            handleDay(REDUCER_ACTION_TYPE.LAST_DAY, e)
          }
          label="The last day of leave"
        />
        <TextField
          onChange={(e: ChangeEvent<HTMLInputElement>) =>
            handleValue(e, REDUCER_ACTION_TYPE.KIND_LEAVE)
          }
          className={LeaveFormModule.listForm}
          variant="outlined"
          select
        ...
        <TextField
          onChange={(e: ChangeEvent<HTMLInputElement>) =>
            handleValue(e, REDUCER_ACTION_TYPE.REPLACE_PERSON)
          }
          className={LeaveFormModule.listForm}
          variant="outlined"
          select
        ...
        <Button className={LeaveFormModule.buttonForm} onClick={() => leavePlanHandle()} variant="contained">
          Send request.
        </Button>
