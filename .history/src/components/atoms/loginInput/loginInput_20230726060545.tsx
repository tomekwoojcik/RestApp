...
function LoginInput() {
  ...
  return (
    <Input onChange={e => { handleValue(e, setLoginValue); }} id="loginInput" className={LoginInputModule.loginInput} type="text" name="id" placeholder="Enter your email or work id." />
  );
}
