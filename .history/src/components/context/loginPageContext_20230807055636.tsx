...
type HandleValueFunction = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>, input: any) => any;
...
export function LoginPageProvider({ children }:props) {
  ...
  const handleValue = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>, input: any) => input(e.target.value);
