...
interface SubordinatesRowProps {
  ...
  StyledTableRow: any;
  StyledTableCell: any;
  getEmployeeLeave: () => void;
}

const EmployeeTableRow: FC<SubordinatesRowProps> = ({ subordinatesObj, StyledTableRow, StyledTableCell, getEmployeeLeave }) => {
  return (
    <StyledTableRow>
      ...
      <StyledTableCell>
        <Button onClick={() => getEmployeeLeave()}>Show employee leaves</Button>
      </StyledTableCell>
    </StyledTableRow>
  );
};
