...
const subordinatesArr : UserModel[] = (await getUsersResource(userToken)).data.filter((object:UserModel)=> object.user.company.supervisorId == getUserData.user.company.supervisorId);
