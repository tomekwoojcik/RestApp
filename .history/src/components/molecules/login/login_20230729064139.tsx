...
const Login: FC = () => {
  ...
  return (
    <form className={LoginModule.login}>
      ...
      {toggleLogin ? <Button variant="contained" color="primary" className={LoginModule.loginButton} id="loginButton" onClick={() => loginHandle()}> LogIn  </Button> : <Button variant="contained" color="primary" className={LoginModule.loginButton} id="loginButton" onClick={() => toggleValue()}> Continue  </Button>}
      <p>OR</p>
